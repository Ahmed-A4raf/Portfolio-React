  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form action="https://getform.io/f/anlllyva" method="post" className="xl:pl-10 2xl:pl-20">
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-6">
                <div className="mb-4">

                    <label htmlFor="name" className="label reveal-up">Name</label>

                    <input type="text" name="name" autoComplete="name" required placeholder="Ahmed Ashraf" id="name" className="text-field reveal-up" />
                ...
                <div className="mb-4">
                    ...
                    <input type="email" name="email" autoComplete="email" required placeholder="ahmedashraf12777@gmail.com" id="email" className="text-field reveal-up" />
